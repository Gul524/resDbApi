...
import com.asadevelopers.resDbApi.repository.FlavourRepository;
import com.asadevelopers.resDbApi.repository.TableRepository;
...
public class FlavourService {
    ...
    public ResponseEntity<ApiResponse<List<Flavour>>> getAllByBranchId(Integer id) {
        try {
